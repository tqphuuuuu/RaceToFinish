...
struct Z_Construct_UClass_ARaceToFinishPlayerController_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_MoveForward_MetaData[] = {
		{ "AllowPrivateAccess", "true" },
		{ "Category", "Input" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "// Move Action\n" },
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_MoveRight_MetaData[] = {
		{ "AllowPrivateAccess", "true" },
		{ "Category", "Input" },
		{ "ModuleRelativePath", "RaceToFinishPlayerController.h" },
	};
	...
	static const UECodeGen_Private::FObjectPropertyParams NewProp_MoveForward;
	static const UECodeGen_Private::FObjectPropertyParams NewProp_MoveRight;
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ARaceToFinishPlayerController_Statics::NewProp_MoveForward = { "MoveForward", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ARaceToFinishPlayerController, MoveForward), Z_Construct_UClass_UInputAction_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_MoveForward_MetaData), NewProp_MoveForward_MetaData) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ARaceToFinishPlayerController_Statics::NewProp_MoveRight = { "MoveRight", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ARaceToFinishPlayerController, MoveRight), Z_Construct_UClass_UInputAction_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_MoveRight_MetaData), NewProp_MoveRight_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ARaceToFinishPlayerController_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ARaceToFinishPlayerController_Statics::NewProp_MoveForward,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ARaceToFinishPlayerController_Statics::NewProp_MoveRight,
};
...
struct Z_CompiledInDeferFile_FID_Users_TQPhuuuuu_Desktop_GitHub_RaceToFinish_RaceToFinishh_RaceToFinish_Source_RaceToFinish_RaceToFinishPlayerController_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ARaceToFinishPlayerController, ARaceToFinishPlayerController::StaticClass, TEXT("ARaceToFinishPlayerController"), &Z_Registration_Info_UClass_ARaceToFinishPlayerController, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ARaceToFinishPlayerController), 2581828084U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_TQPhuuuuu_Desktop_GitHub_RaceToFinish_RaceToFinishh_RaceToFinish_Source_RaceToFinish_RaceToFinishPlayerController_h_1901855579(TEXT("/Script/RaceToFinish"),
